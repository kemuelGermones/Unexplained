...
const seedDatabase = async () => {
  ...
  for (let i = 0; i <= 50; i++) {
    const report = new Report({
      ...
      description:
        "Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis provident nesciunt eaque tempore dicta, veritatis fuga id nisi tenetur, impedit adipisci obcaecati accusamus quaerat rem neque deserunt commodi quo asperiores.",
      images: [
        {
