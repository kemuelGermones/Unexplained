...
router.post('/', isLoggedIn, upload.array('image'), validateReport, wrapAsync(report.createReport));
...
// Edit report route
router.put('/:id', isLoggedIn, isAuthor, upload.array('image'), validateReport, wrapAsync(report.editReport));
